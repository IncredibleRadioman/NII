...
QT_MOC_LITERAL(1, 11, 14), // "screenCaptured"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "updateCaption"
QT_MOC_LITERAL(4, 41, 8), // "shotLoop"
QT_MOC_LITERAL(5, 50, 8), // "interval"
QT_MOC_LITERAL(6, 59, 4) // "stop"

    },
    "ScreenShot\0screenCaptured\0\0updateCaption\0"
    "shotLoop\0interval\0stop"
};
...
void ScreenShot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->screenCaptured(); break;
        case 1: _t->updateCaption(); break;
        case 2: _t->shotLoop((*reinterpret_cast< qint16(*)>(_a[1]))); break;
        ...
        {
            typedef void (ScreenShot::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreenShot::screenCaptured)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ScreenShot::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScreenShot.data,
...
// SIGNAL 0
void ScreenShot::screenCaptured()
{
